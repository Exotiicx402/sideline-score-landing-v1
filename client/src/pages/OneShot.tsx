/**
 * Design Philosophy: Minimal Black & White
 * - Pure black and white aesthetic, no color accents
 * - No branding/logo displayed
...
export default function OneShot() {
  return (
    <div className="min-h-screen relative overflow-hidden bg-black flex items-center justify-center">
      ...
      {/* Footer Legal Text */}
      <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-black to-transparent py-8">
